...
class SHHA_Sim_Adaptive_Kernel(BaseDataset):
    def __init__(self,
                 config,
                 root,
                 list_path,
        ...
        super(SHHA_Sim_Adaptive_Kernel, self).__init__(ignore_label, base_size,
        ...
        if 'test' in self.list_path:
            for item in self.img_list:
                ...
                files.append({
                    ...
                    "name": image_id,
                    "gt_den": "den_maps_depth/" + image_id + '.h5',
                })
        else:
            for item in self.img_list:
                # import pdb
    ...
    def __getitem__(self, index):
        ...
        if 'val' in self.list_path or 'test' in self.list_path:
            ...
            gt_den_map_x1 = np.expand_dims(gt_den_map, axis=0).copy()
