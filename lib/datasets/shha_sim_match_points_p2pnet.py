...
class SHHA_Sim_Match_Points_P2PNet(BaseDataset):
    def __init__(self,
                 config,
                 root,
                 list_path,
        ...
        super(SHHA_Sim_Match_Points_P2PNet, self).__init__(ignore_label, base_size,
        ...
        for _, train_list in enumerate(self.img_list_file):
            ...
            with open(os.path.join(self.root, train_list)) as fin:
                for line in fin:
                    ...
                    self.img_map[os.path.join(self.root, line[0].strip())] = \
                        os.path.join(self.root, line[1].strip())
    ...
    def __getitem__(self, index):
        ...
        if self.train:
            ...
            if self.patch:
                img, point = self.random_crop(img, point, self.patch_size)
