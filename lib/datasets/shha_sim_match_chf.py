...
class SHHA_Sim_Match_Chf(BaseDataset):
    def __init__(self,
                 config,
                 root,
                 list_path,
        ...
        super(SHHA_Sim_Match_Chf, self).__init__(ignore_label, base_size,
    ...
    def __getitem__(self, index):
        ...
        return image.copy(), label, np.array(size), [name, idx, resize_factor], chf
