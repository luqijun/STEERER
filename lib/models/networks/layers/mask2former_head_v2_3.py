...
class Mask2FormerHead_v2_3(nn.Module):
    ...
    def __init__(self, decoder,
        ...
        super(Mask2FormerHead_v2_3, self).__init__()
        ...
        for _ in range(self.num_transformer_decoder_layers + 1):
            transformer = nn.Transformer(feat_channels, 8, num_encoder_layers=1, num_decoder_layers=1, batch_first=True)
