...
# 使用transformer提取人头特征， 分割与生成密度图共用一个查询向量。使用2层decoderlayer
class Mask2FormerHead4_2(nn.Module):
    ...
    def __init__(self, decoder,
        ...
        super(Mask2FormerHead4_2, self).__init__()
    ...
    def get_sim_map(self, x, x_pos, sim_features, sim_features_pos, layer_num):
        ...
        for i, window_size in enumerate(self.window_sizes):
            ...
            output = self.sim_map_decoders[0](output, tgt)
