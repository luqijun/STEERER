...
# 使用transformer提取人头特征， 分割与生成密度图共用一个查询向量, 生成4个mask, 使用transformer结构
class Mask2FormerHead_v2_2(nn.Module):
    ...
    def __init__(self, decoder,
        ...
        super(Mask2FormerHead_v2_2, self).__init__()
        ...
        # upsample
        self.upsample_block = make_head_layer2(feat_channels, feat_channels // 2)
