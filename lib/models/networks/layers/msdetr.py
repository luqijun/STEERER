...
from .typing_utils import OptMultiConfig
from mmengine.config import ConfigDict
from lib.models.networks.layers.task_modules.prior_generators import MlvlPointGenerator
from .positional_encoding import SinePositionalEncoding
from .detr.mask2former_layers import Mask2FormerTransformerEncoder
...
class MSDeformAttnPixelDecoder(BaseModule):
    ...
    def __init__(self,
                 ...
                 num_outs: int = 3,
                 norm_cfg: ConfigDict = dict(type='GN', num_groups=32),
                 act_cfg: ConfigDict = dict(type='ReLU'),
                 encoder: ConfigDict = None,
                 positional_encoding: ConfigDict = dict(
