...
# 使用transformer提取人头特征，使用10个查询向量，第一个查询向量用于分割预测。全部查询向量用于生成密度图。
class Mask2FormerHead4_1(nn.Module):
    ...
    def __init__(self, decoder,
        ...
        super(Mask2FormerHead4_1, self).__init__()
    ...
    def forward(self, x: List[Tensor]):
        ...
        mask_pred_list.append(mask_pred[:, 0:1])
