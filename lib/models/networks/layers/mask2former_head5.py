...
# 使用卷积+transformer提取人头特征
class Mask2FormerHead5(nn.Module):
    ...
    def __init__(self, decoder,
        ...
        super(Mask2FormerHead5, self).__init__()
    ...
    def get_sim_map(self, x, x_pos, mask_pred, sim_features, sim_features_pos, layer_num):
        ...
        sim_features = torch.cat([sim_features, kernel], dim=0)
