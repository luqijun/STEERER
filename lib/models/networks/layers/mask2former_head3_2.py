...
# 使用卷积提取人头特征, 使用卷积获得（7*7）的相似特征
class Mask2FormerHead3_2(nn.Module):
    ...
    def __init__(self, decoder,
        ...
        super(Mask2FormerHead3_2, self).__init__()
        ...
        # 提取卷积核
        self.conv_kernel_extrator = make_kernel_extractor_adaptive(feat_channels, (9, 9))
